...
TurtleWolfe is a **static-first web application** designed for deployment on GitHub Pages with Supabase as the backend-as-a-service.
...
TurtleWolfe deploys to **GitHub Pages**, which only serves static files. This means:
