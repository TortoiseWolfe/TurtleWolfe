...
Changes made to TurtleWolfe based on feedback from forked projects.
...
**Manual fix**: Delete `public/CNAME` if it contains `turtlewolfe.com`
...
**Manual fix**: Search for `turtlewolfe-` in service worker files and replace with your project name.
...
2. Submit a PR to TurtleWolfe or open an issue
3. Help future users avoid the same problems!

[TurtleWolfe Issues](https://github.com/TortoiseWolfe/TurtleWolfe/issues)
