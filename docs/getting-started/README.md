# Getting Started with TurtleWolfe
...
```bash
git clone https://github.com/YOUR_ORG/TurtleWolfe.git
cd TurtleWolfe
```
...
```
NAME                    STATUS
turtlewolfe-app        running
turtlewolfe-db         running (if applicable)
```
...
TurtleWolfe is a **planning template** for AI-assisted development. It contains:
