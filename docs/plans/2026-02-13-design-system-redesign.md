# TurtleWolfe Design System Redesign
...
- "TurtleWolfe" evokes craftsmanship, power tools, building software
...
**TurtleWolfe-specific:** TurtleWolfe has 33 atomic directories (vs SpokeToWork's 29). Audit the extras for misplacement before moving.
...
Build TurtleWolfe brand theme with dark and light variants.
...
5. AnimatedLogo / SpinningLogo (TurtleWolfe's mallet)

TurtleWolfe-specific:

- Dice / DiceTray (gaming elements, unique to TurtleWolfe)
