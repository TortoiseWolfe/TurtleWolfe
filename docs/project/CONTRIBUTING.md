...
docker compose exec turtlewolfe pnpm dev       # Dev server
docker compose exec turtlewolfe pnpm test      # Run tests
docker compose exec turtlewolfe pnpm lint      # Run linting
docker compose exec turtlewolfe pnpm format    # Format code
docker compose exec turtlewolfe pnpm storybook  # Storybook
docker compose exec turtlewolfe pnpm type-check # TypeScript
```
...
| Script                                               | Description                      |
| ---------------------------------------------------- | -------------------------------- |
| `docker compose exec turtlewolfe pnpm dev`           | Start Next.js development server |
| `docker compose exec turtlewolfe pnpm build`         | Build for production             |
| `docker compose exec turtlewolfe pnpm test`          | Run Vitest tests                 |
| `docker compose exec turtlewolfe pnpm test:coverage` | Generate coverage report         |
| `docker compose exec turtlewolfe pnpm lint`          | Run ESLint                       |
| `docker compose exec turtlewolfe pnpm format`        | Format code with Prettier        |
| `docker compose exec turtlewolfe pnpm format:check`  | Check formatting without changes |
| `docker compose exec turtlewolfe pnpm type-check`    | Run TypeScript type checking     |
| `docker compose exec turtlewolfe pnpm storybook`     | Start Storybook development      |
...
- Review [existing issues](https://github.com/TortoiseWolfe/TurtleWolfe/issues)
- Ask in discussions
