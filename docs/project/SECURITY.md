...
We take the security of TurtleWolfe seriously. If you believe you have found a security vulnerability in TurtleWolfe, please report it to us as described below.
...
- Email us at security@turtlewolfe.com
...
When using TurtleWolfe in production, we recommend:
...
TurtleWolfe includes several built-in security features:
...
- Security Email: security@turtlewolfe.com
- Project Maintainers: See CONTRIBUTING.md

## Acknowledgments

We appreciate the security research community's efforts in helping keep TurtleWolfe and our users safe. Responsible disclosure of vulnerabilities helps us ensure the security and privacy of our users.
