...
docker compose exec turtlewolfe pnpm run generate:component SocialShareButton blog
docker compose exec turtlewolfe pnpm run generate:component SocialShareGroup blog
docker compose exec turtlewolfe pnpm run generate:component AuthorAvatar blog
docker compose exec turtlewolfe pnpm run generate:component AuthorBio blog
docker compose exec turtlewolfe pnpm run generate:component SocialLink blog
docker compose exec turtlewolfe pnpm run generate:component AuthorSocialLinks blog
docker compose exec turtlewolfe pnpm run generate:component AuthorProfile blog
docker compose exec turtlewolfe pnpm run generate:component ShareMetadata blog
```
...
docker compose exec turtlewolfe pnpm test SocialShareButton
...
```bash
# Start Storybook
docker compose exec turtlewolfe pnpm run storybook
...
```bash
# Run Pa11y tests
docker compose exec turtlewolfe pnpm run test:a11y
...
docker compose exec turtlewolfe pnpm run analyze
