...
**Input**: Feature specification from `/home/turtle_wolfe/repos/TurtleWolfe/specs/023-user-messaging-system/spec.md`
...
- Use component generator: `docker compose exec turtlewolfe pnpm run generate:component`
...
- Commands executed via: `docker compose exec turtlewolfe pnpm run <command>`
...
**Structure Decision**: Web application structure (Option 2) selected. TurtleWolfe uses Next.js App Router with:
...
All requirements align with TurtleWolfe constitution v1.0.1. No complexity exceptions needed.
