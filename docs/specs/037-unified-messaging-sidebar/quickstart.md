...
- Docker running with TurtleWolfe container
...
docker compose exec turtlewolfe pnpm test ConnectionManager
docker compose exec turtlewolfe pnpm test UnifiedSidebar
