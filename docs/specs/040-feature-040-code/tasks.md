...
```
Command: docker compose exec turtlewolfe pnpm test
...
```
Command: docker compose exec turtlewolfe pnpm test --coverage src/lib/logger/
...
```
Command: docker compose exec turtlewolfe pnpm run build
