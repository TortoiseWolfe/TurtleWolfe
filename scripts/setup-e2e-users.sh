...
if ! docker compose ps turtlewolfe | grep -q "Up"; then
    echo "❌ Error: Docker container 'turtlewolfe' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec turtlewolfe pnpm exec playwright test tests/e2e/messaging/"
echo ""
