...
# Test Suite Runner for TurtleWolfe
...
echo ""
echo -e "${BLUE}${BOLD}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}${BOLD}║                  TurtleWolfe Comprehensive Test Suite               ║${NC}"
echo -e "${BLUE}${BOLD}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if in_docker; then
    ...
    CMD_PREFIX="docker compose exec turtlewolfe"
fi
...
if ! in_docker; then
    ...
    docker compose restart turtlewolfe > /dev/null 2>&1
