...
- [x] T019 [US1] Run tests: `docker compose exec turtlewolfe pnpm test welcome-service`

- [x] T020 [US1] Manual verification: Sign up new user, check conversations for welcome message from turtlewolfe
...
- [x] T033 [POLISH] Run full test suite: `docker compose exec turtlewolfe pnpm test`

- [x] T034 [POLISH] Run type check: `docker compose exec turtlewolfe pnpm type-check`

- [x] T035 [POLISH] Run linter: `docker compose exec turtlewolfe pnpm lint`
