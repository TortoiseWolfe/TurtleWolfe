...
docker compose exec turtlewolfe pnpm run type-check  # No any type errors
docker compose exec turtlewolfe pnpm run lint        # No ESLint warnings
docker compose exec turtlewolfe pnpm test            # All tests pass

# Final verification
docker compose exec turtlewolfe pnpm run build       # Production build clean
```
...
| SC-006: A11y passes            | `docker compose exec turtlewolfe pnpm run test:a11y`                        |
