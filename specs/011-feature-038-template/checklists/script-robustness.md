...
- [ ] CHK005 - Are all case variations to replace documented (TurtleWolfe, turtlewolfe, SCRIPTHAMMER)? [Completeness, Spec §FR-002]
...
- [ ] CHK046 - Is behavior defined for binary files that might contain "TurtleWolfe"? [Edge Case, Gap]
