...
- [x] T008 [US1] Implement previous-rebrand detection (grep for "TurtleWolfe" count)
...
- [x] T012 [US1] Implement file renaming for files containing "TurtleWolfe" in name
...
**Independent Test**: Run `docker compose exec turtlewolfe git commit -m "test"` after change
