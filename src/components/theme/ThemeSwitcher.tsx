...
export function ThemeSwitcher() {
  const [currentTheme, setCurrentTheme] = useState('turtlewolfe-dark');
  ...
  useEffect(() => {
    ...
    let savedTheme = 'turtlewolfe-dark';

    if (canPersist) {
      // Use localStorage if functional cookies allowed
      savedTheme = localStorage.getItem('theme') || 'turtlewolfe-dark';
    } else {
      // Use sessionStorage as fallback
      savedTheme = sessionStorage.getItem('theme') || 'turtlewolfe-dark';
    }
